...
against[seq(1,length(against),by = 2)]
...
names(against2) <- 1:length(against2)
...
against2[14 <= against2 & 21 >= against2]

# select those games with 13 or 14 points
against2[14 == against2 | 13 == against2]
